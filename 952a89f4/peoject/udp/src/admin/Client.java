		 ...
		 if(g.getSource()==button){//连接
			 ...
			 String ip="";
				try {
					...
					int i=JOptionPane.showConfirmDialog(null,"ip："+ip+" port "+sendTextPort+" 上的服务器并没有启动，是否需要继续？","继续",JOptionPane.YES_NO_OPTION);
					if(i==1){
